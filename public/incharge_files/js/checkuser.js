...
if (!user) {
    ...
    $.ajax({
        ...
        success: (data) => {
            ...
            let image = `
                <img class="avatar lg rounded-circle img-thumbnail pulse " src="../img-user/${info.profile_img ? `${info.profile_img}`: `incharge-${info.gender}.jpg` }" alt="a profile picture of ${info.firstname}">
                <span class="pulse-ring"></span>
            `
            let profile_nav = `
                <div class="card-body pb-0">
                    <div class="d-flex py-1">
                        <img class="avatar rounded-circle" src="../img-user/${info.profile_img ? `${info.profile_img}`: `incharge-${info.gender}.jpg` }" alt="a profile picture of ${info.firstname}">
                ...
                <div class="list-group m-2 ">
                    <a href="/incharge/profile" class="list-group-item list-group-item-action border-0 "><i class="icofont-ui-user fs-5 me-3"></i>Profile Page</a>
                    <a href="/incharge/order-invoice" class="list-group-item list-group-item-action border-0 "><i class="icofont-file-text fs-5 me-3"></i>Order Invoices</a>
