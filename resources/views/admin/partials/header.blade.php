                    ...
                    <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                        ...
                        <div class="dropdown zindex-popover">
                            <a class="nav-link dropdown-toggle pulse" href="#" role="button"
                                ...
                                <img src="/admin_files/images/GB.png" alt>
                            </a>
                            <div
                                ...
                                <div class="card border-0">
                                    <ul class="list-unstyled py-2 px-3">
                                        <li>
                                            <a href="#" class><img src="/admin_files/images/GB.png" alt> English</a>
                                        </li>
                                        <li>
                                            <a href="#" class><img src="/admin_files/images/DE.png" alt> German</a>
                                        </li>
                                        <li>
                                            <a href="#" class><img src="/admin_files/images/FR.png" alt> French</a>
                                        </li>
                                        <li>
                                            <a href="#" class><img src="/admin_files/images/IT.png" alt> Italian</a>
                                        </li>
                                        <li>
                                            <a href="#" class><img src="/admin_files/images/RU.png" alt> Russian</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                            <div class="u-info me-2">
                                <p class="mb-0 text-end line-height-sm "><span
                                        class="font-weight-bold admin-name"></span></p>
                                <small>Admin Profile</small>
                            </div>
                            <a class="nav-link dropdown-toggle pulse p-0 profile-image" href="#"
